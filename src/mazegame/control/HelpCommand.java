...
public class HelpCommand implements Command {
	...
	public CommandResponse execute(ParsedInput userInput, Player thePlayer) {
		...
		message.append("\nThe list of the commands and how to use it is given below\n\n");
		message.append(
		...
		message.append(
				"list => gives the list of the items that a player holds,\n\tno parameters required\n\tSyntax -- list\n\n");
		message.append(
				"get => collects new item, \n\t takes name of the item as parameter\n\tSyntax -- get <Item name>\n\n");
		message.append(
				"pick => collects new item, \n\t takes name of the item as parameter\n\tSyntax -- get <Item name>\n\n");
		...
		message.append(
				"attack => attacks the character,\n\tno parameters are required \n\tSyntax -- catch <Hostile Character name> \n\n");
